<?php
	...
	$s 			= ($page-1)*$sayi;
	$sayfa		= "populer-porno-videolar";
	$sayfaisim	= "Popüler Porno Videolar";
...
<div id="mainblok">
  ...
  <div id="rightblok">
    ...
    <h2>Popüler porno Videolar</h2>
    <div class="video_list_blok">
      <?php
			
				$new = $db->tablo("SELECT wievs,thumb,title,times,rating,seo FROM video ORDER BY rating DESC LIMIT $s,$sayi");
				foreach ($new as $nx){
