<script type="text/javascript"> 
	...
	$.ajax({ 
	type:'POST', 
	url:'botlar/cek/m_v5_etiket.php', 
	...
	success:function(cevap){ 
		...
		<div class="sonucu basliks">MAHİRİX V5 ETİKET BOTU</div>
		<div class="blok">
		...
		<form id="update">
			<div id="form_alani">
				<div class="formlist"><span>Sayfa Adresi </span><input name="sx" class="inp"/></div>
